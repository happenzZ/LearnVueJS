		...
		<nav class="navbar navbar-default">
			<div class="container-fluid">
				<div class="navbar-header">
					<button id="navBarToggle" v-on:click.stop="toggleNavBar" type="button" class="navbar-toggle collapsed" data-toggle="collapse"
          ...
          <span class="icon-bar"></span>
				...
				<div id="navbarCollapse" class="collapse navbar-collapse">
					...
					<ul class="nav navbar-nav">
						...
						<li v-link="{ path: '/comment', activeClass: 'active' }"><a v-link="{ path: '/comment' }"><span class="glyphicon glyphicon-comment"></span> 留言</a></a>
						</li>
